          ...
          <div>
            <div className="flex items-center space-x-3 mb-6">
              ...
              <div>
                ...
                <p className="text-base text-zinc-200 leading-relaxed">Nexus Capital Virtual Data Room & Pipeline Desk</p>
              </div>
            </div>

            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <label className="block text-sm font-semibold font-mono text-blue-400 uppercase tracking-wider mb-2">
              ...
              <div className="pt-2 flex flex-col sm:flex-row gap-3">
                ...
                <button
                  ...
                  className="py-3 px-4 bg-blue-950/60 hover:bg-blue-900/60 border border-blue-500/30 text-blue-300 font-mono text-base font-semibold min-h-[44px] rounded-xl transition-all"
                >
                  ⚡ Auto-Fill: ma2026
                </button>
              </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between pb-4 border-b border-slate-800">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-base text-zinc-200 leading-relaxed">Active Sell-Side & Buy-Side Deals Under Exclusivity</p>
                </div>
              </div>
              <span className="px-2.5 py-1 text-xs font-semibold tracking-wider font-mono bg-blue-500/10 text-blue-400 border border-blue-500/30 rounded-full flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="p-4 bg-slate-900/80 border border-slate-800 rounded-xl">
                ...
                <div className="text-xs font-semibold tracking-wider text-emerald-400 mt-1">7 Active Mandates</div>
              </div>
              ...
              <div className="p-4 bg-slate-900/80 border border-slate-800 rounded-xl">
                ...
                <div className="text-xs font-semibold tracking-wider text-cyan-400 mt-1">100% Executed NDAs</div>
              </div>
              ...
              <div className="p-4 bg-slate-900/80 border border-slate-800 rounded-xl">
                ...
                <div className="text-xs font-semibold tracking-wider text-emerald-400 mt-1">Adjusted EBITDA</div>
              </div>
            </div>
            ...
            <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4">
              ...
              <div className="space-y-2 text-xs">
                <div className="flex items-center justify-between p-2.5 bg-slate-950/60 rounded-lg border border-slate-800/80">
                  ...
                  <span className="text-emerald-400 font-mono text-xs font-semibold bg-emerald-500/10 px-2 py-0.5 rounded border border-emerald-500/20">LOI STAGE</span>
                </div>
                <div className="flex items-center justify-between p-2.5 bg-slate-950/60 rounded-lg border border-slate-800/80">
                  <div>
                  ...
                  <span className="text-cyan-400 font-mono text-xs font-semibold bg-cyan-500/10 px-2 py-0.5 rounded border border-cyan-500/20">DUE DILIGENCE</span>
                </div>
                <div className="flex items-center justify-between p-2.5 bg-slate-950/60 rounded-lg border border-slate-800/80">
                  <div>
                  ...
                  <span className="text-purple-400 font-mono text-xs font-semibold bg-purple-500/10 px-2 py-0.5 rounded border border-purple-500/20">DEFINITIVE APA</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between pt-2">
              ...
              <div className="flex gap-2">
                <button
                  onClick={onClose}
                  className="px-5 py-3 min-h-[44px] bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-xl text-base font-semibold min-h-[44px] transition-all shadow-md font-mono"
                >
                  Close Console
                </button>
              </div>
